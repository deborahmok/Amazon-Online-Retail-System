...
Product *ProductBookParser::makeProduct()
{
    ...
    Book *newBook = new Book(isbn_, author_, category_, prodName_, price_, qty_);
    return newBook;
}
...
{
    string category_ = categoryID();
    Clothing *newClothing = new Clothing(size_, brand_, category_, prodName_, price_, qty_);
    return newClothing;
}
...
{
    string category_ = categoryID();
    Movie *newMovie = new Movie(genre_, rating_, category_, prodName_, price_, qty_);
    return newMovie;
}
